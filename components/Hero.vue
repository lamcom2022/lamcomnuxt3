<template>
	<main
		...
		<h1 class="capitalize font-semibold text-[38px] lg:text-7xl text-center leading-snug text-white">			
			<span class="font-normal text-[24px] bg-clip-text text-white lg:text-3xl uppercase">A Better Way to Clean</span><br />
			<span class="font-extrabold bg-clip-text text-primary-500 uppercase">A Cleaner Way to Live</span>
		</h1>
		<p class="mt-10 text-small text-center text-white font-normal lg:text-3xl ">
			Find all kinds of industrial cleaning machines
		</p>
