...
<main
		...
		<h1 class="capitalize font-semibold lg:text-2xl text-white mx-4 text-center">			
			<span class="font-normal text-[24px] bg-clip-text text-white lg:text-3xl uppercase">We Always Try to Satisfy Clients</span><br />
			
		</h1>
		<p class="mt-5 text-center text-small text-white font-normal lg:text-lg mx-4">
			Banglore's best manufacturer and distributers of cleaning machines, cleaning tools, and house keeping consumable.
		</p>
