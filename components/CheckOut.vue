<template>
  <section class="grid">
    <div
      class="grid lg:grid-cols-2 md:grid-cols-1 mt-0 h-full lg:w-3/4 md:w-1/2 py-12 pb-24 mx-12"
    >
      <div
        class="flex flex-col xl:w-11/12 md:w-1/5 h-full md:mx-2 mt-12 shadow-lg shadow-gray-900"
      >
        <h2
          class="flex flex-col lg:text-center text-xl text-gray-700 mx-4 md:text-left font-semibold uppercase pb-12 mt-10"
        >
          Shipping Address
        </h2>
        <h2
          class="flex flex-col text-lg text-gray-700 mx-4 lg:mx-32 font-semibold uppercase"
        >
          Shipping Details
        </h2>
        <form>
          ...
          >
            ...
            <label
              for="AddressLine2"
              class="form-label inline-block mb-2 text-gray-700 font-semibold"
              ><span class="text-white px-2 text-lg gap-2 font-semibold">*</span
              >Address Line2</label
            >
            <input
              type="text"
            ...
            <div class="grid md:grid-cols-1 lg:grid-cols-2">
              <div class="flex flex-col px-2">
                <label
                  for="Landmark"
                  class="form-label inline-block mb-2 text-gray-700 font-semibold flex flex-col"
                >
                  <span class="text-secondary text-lg px-2 gap-2 font-semibold"
                    >*</span
                  >Landmark
                </label>
                <input
              ...
              <div class="flex flex-col px-2">
                <label
                  for="Pincode"
                  class="form-label inline-block mb-2 text-gray-700 font-semibold md:flex md:flex-col"
                >
                  <span class="text-secondary text-lg px-2 gap-2 font-semibold"
                    >*</span
                  >Pincode</label
            ...
            <div class="flex mt-3 mx-4">
              <input
                type="checkbox"
                class="appearance-none indeterminate:bg-secondary py-3 w-6 h-6"
              />
              <span class="text-lg text-gray-700 inline-flex mx-4"
      ...
      <div class="flex flex-col w-full h-full md:mx-3 lg:mx-32 mt-12">
        ...
        <div class="grid lg:grid-cols-2 md:grid-cols-1">
          <div class="w-64 h-64 bg-gray-400">
            <img class="bg-none" :src="this.purl" />
          </div>
        ...
        <div
          class="lg:text-center md:text-center gap-4 w-full lg:grid lg:grid-cols-2"
        >
          <div class="mt-6 w-full">
            <p class="text-lg text-gray-700 uppercase font-bold">Total</p>
          </div>
          <div class="mt-6 flex flex-col">
            <p class="text-lg text-gray-700 font-bold">Rs.{{ this.total }}</p>
          </div>
        </div>

        <div
          class="flex flex-col lg:text-center md:text-left gap-4 w-full lg:grid lg:grid-cols-2"
        >
          <div class="mt-6 w-full flex flex-col">
            <p
              class="text-lg text-gray-700 lg:text-center md:text-left uppercase font-bold"
            >
              Discount
            </p>
          </div>
        ...
        >
          <div class="mt-6 w-full flex flex-col">
            <p
              class="text-lg text-gray-700 font-bold lg:text-center md:text-left"
            >
              Shipping Charges
            </p>
          </div>
        ...
        >
          <div class="mt-6 w-full flex flex-col">
            <p
              class="text-lg text-gray-700 lg:text-center md:text-left font-bold"
            >
              Around Total
            </p>
          </div>
        ...
        <div class="mt-12 lg:items-center md:items-center">
          <button
            class="rounded-full bg-gray-600 text-white uppercase w-80 h-12 lg:mx-64 md:mx-4 font-bold"
          >
            Proceed to Review
          </button>
        </div>
