    ...
    <form class="mt-6 space-y-8 divide-y divide-y-blue-gray-200">
      <div class="grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-6">
        ...
        <div class="sm:col-span-3">
          ...
          <input type="text" value="Ramanathan" name="first-name" id="first-name" autocomplete="given-name"
            class="mt-1 block w-full border-blue-gray-300 shadow-sm text-blue-gray-900 sm:text-sm focus:ring-blue-500 focus:border-blue-500" />
        </div>

        <div class="sm:col-span-3">
          <label for="last-name" class="block text-sm font-medium text-blue-gray-900"> Last name </label>
          <input type="text" value="schwarz" name="last-name" id="last-name" autocomplete="family-name"
            class="mt-1 block w-full border-blue-gray-300 shadow-sm text-blue-gray-900 sm:text-sm focus:ring-blue-500 focus:border-blue-500" />
        </div>
        ...
        <div class="sm:col-span-6">
          ...
          <div class="mt-1 flex shadow-sm">
            <input type="text" name="username" id="username" autocomplete="username" value="Ramanathan"
      ...
      <div class="pt-8 grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-6">
        ...
        <div class="sm:col-span-3">
          ...
          <input type="text" value="ramanathan@zynomi.com" name="email-address" id="email-address" autocomplete="email"
            class="mt-1 block w-full border-blue-gray-300 shadow-sm text-blue-gray-900 sm:text-sm focus:ring-blue-500 focus:border-blue-500" />
        </div>

        <div class="sm:col-span-3">
          <label for="phone-number" class="block text-sm font-medium text-blue-gray-900"> Phone number </label>
          <input type="text" value="+1 520-789-1143" name="phone-number" id="phone-number" autocomplete="tel"
            class="mt-1 block w-full border-blue-gray-300 shadow-sm text-blue-gray-900 sm:text-sm focus:ring-blue-500 focus:border-blue-500" />
        </div>
        ...
        <p class="hidden text-sm text-blue-gray-500 sm:col-span-6">This account was created on <time
            datetime="2017-01-05T20:35:40">January 5, 2017, 8:35:40 PM</time>.</p>
      </div>
    </form>
  </div>
</template>
