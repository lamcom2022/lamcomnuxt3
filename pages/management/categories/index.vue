...
<script>
import MemberPageHeader from "~~/pages/management/categories/CategoryPageHeader.vue";
import MemberSearch from "~~/pages/management/categories/CategorySearch.vue";
import MemberDataTable from "~~/pages/management/categories/CategoryGrid.vue";
import MemberUpsert from "~~/pages/management/categories/CategoryUpsert.vue";
