  ...
  <header class="w-full">
    ...
    >
      <div class="flex-1 flex justify-between px-2 sm:px-2">
        ...
        <div
          v-if="pgShowbutton == 'true'"
          class="ml-2 mt-2 pr-6 flex items-center space-x-4 sm:ml-6 sm:space-x-6"
        >
          <button
            @click="useNuxtApp().$bus.$emit('evtFilterMember')"
            type="button"
          ...
          <button
            @click="useNuxtApp().$bus.$emit('evtUpsertCategory')"
            type="button"
