						...
						<div class="flex-1 h-0 overflow-y-auto">
							<header class="space-y-1 py-6 px-4 bg-gray-200 sm:px-6">
								<div class="flex items-center justify-between space-x-3">
									...
									<div class="h-7 flex items-center">
										<button v-on:click="closeUserPanel()" aria-label="Close panel" class="text-gray-600 hover:text-white transition ease-in-out duration-150">
							...
							<div v-if="!progress" class="flex-1 flex flex-col justify-between">
								<div class="px-4 divide-y divide-gray-200 sm:px-6">
									<div class="space-y-6 pt-6 pb-5">
										<form name="frmUser" id="frmUser" class="space-y-8 divide-y divide-gray-200" @submit.prevent="SaveAndUpdate">
												...
												<div class="bg-white space-y-6">
													<div class="grid grid-cols-1 gap-y-3 gap-x-4 sm:grid-cols-6">
														<div class="sm:col-span-6">
															...
															<div class="mt-1">
																<input type="text" id="first_name" name="first_name" v-model="data.first_name" class="py-3 px-4 block w-full pl-5 focus:ring-primary-500 focus:border-primary-500 border-gray-300" />
															</div>
														</div>
														<div class="sm:col-span-6">
															<label for="last_name" class="block text-sm font-medium text-gray-700">Last Name</label>
															<div class="mt-1">
																<input type="text" id="last_name" name="branchNameArabic" v-model="data.last_name" class="py-3 px-4 block w-full pl-5 focus:ring-primary-500 focus:border-primary-500 border-gray-300" />
															</div>
														</div>
														<div class="sm:col-span-6">
														...
														<div class="sm:col-span-6">
															...
															<div class="mt-1">
																<input type="text" id="mobile_phone" name="mobile_phone" v-model="data.mobile_phone" class="py-3 px-4 block w-full pl-5 focus:ring-primary-500 focus:border-primary-500 border-gray-300" />
															</div>
														</div>
														<div class="sm:col-span-6">
															<label for="hand_phone" class="block text-sm font-medium text-gray-700">Hand phone</label>
															<div class="mt-1">
																<input type="text" id="hand_phone" name="hand_phone" v-model="data.hand_phone" class="py-3 px-4 block w-full pl-5 focus:ring-primary-500 focus:border-primary-500 border-gray-300" />
															</div>
														</div>

														<div class="sm:col-span-6">
															<h2 class="text-lg font-medium text-gray-900">Login Information</h2>
														</div>

														<div class="sm:col-span-6">
															<label for="username" class="block text-sm font-medium text-gray-700">Username</label>
															<div class="mt-1">
																<input type="text" id="username" name="username" v-model="data.username" class="py-3 px-4 block w-full pl-5 focus:ring-primary-500 focus:border-primary-500 border-gray-300" />
															</div>
														</div>
														<div class="sm:col-span-6">
															<label for="password" class="block text-sm font-medium text-gray-700">Password</label>
															<div class="mt-1">
																<input type="text" id="password" name="street" v-model="data.password" class="py-3 px-4 block w-full pl-5 focus:ring-primary-500 focus:border-primary-500 border-gray-300" />
															</div>
														</div>
														...
														<div class="sm:col-span-6">
															<CheckBoxGroup
																...
																v-model="data.roles"
																@checked_item="handleCheckedRoles"
																name="roles"
																:data="{
																	data: [
			...
			async upsertUser(args) {
				try {
					...
					if (this.data._id === undefined) {
						const {data: User} = await useFetch("/api/users/store", {
							method: "post",
							body: this.data,
						});
					} else {
