<template>
  <section v-if="isUpsertBillingVisible" class="fixed inset-0 overflow-hidden" aria-labelledby="slide-over-title"
        ...
        <div class="w-screen max-w-md">
          <div class="h-full divide-y divide-gray-200 flex flex-col bg-white shadow-xl">
              ...
              <header class="space-y-1 py-6 px-4 bg-gray-200 sm:px-6">
                <div class="flex items-center justify-between space-x-3">
                  ...
                  <div class="h-7 flex items-center">
                    <button v-on:click="closeBillingPanel()" aria-label="Close panel"
              ...
              <div class="flex-1 flex flex-col justify-between">
                <div class="px-4 divide-y divide-gray-200 sm:px-6">
                  <div class="space-y-6 pt-6 pb-5">
                    <form name="frmBilling" id="frmBilling" class="space-y-8 divide-y divide-gray-200"
                            ...
                            <div class="col-span-3 sm:col-span-4">
                              ...
                              <div class="mt-1">
                                <input type="text" id="name-on-card" name="name-on-card" autocomplete="cc-name"
                                  class="block w-full border-gray-300 shadow-sm focus:ring-Primary-500 focus:border-Primary-500 sm:text-sm" />
                              </div>
                            </div>
            ...
            <div class="w-full flex-shrink-0 px-4 py-4 space-x-4 flex justify-end">
              ...
              <span class="inline-flex rounded-md shadow-sm">
                <button v-on:click="upsertBilling" type="submit"
                  class="inline-flex justify-center py-2 px-4 border border-transparent text-sm leading-5 font-medium text-white bg-Primary-600 hover:bg-Primary-500 focus:outline-none focus:border-Primary-700 focus:shadow-outline-Primary active:bg-Primary-700 transition duration-150 ease-in-out">Save</button>
              </span>
            </div>
          </div>
        </div>
