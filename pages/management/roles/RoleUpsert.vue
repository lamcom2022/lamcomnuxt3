                          ...
                          >
                            ...
                            <div class="sm:col-span-6">
                              <Dropdownlist
                                ...
                                @selected_item="
                                  handleSelectedInRoleMarkAsDelete
                                "
                                name="mark_as_delete"
...
export default {
  ...
  methods: {
        ...
        if (this.data.name !== undefined) {
          alert(
            "upsertRole = " +
              ...
              " " +
              this.data.mark_as_delete
          );
          console.log(this.data);
          const { data: Role } = await useFetch("/api/roles/store", {
            method: "post",
            body: this.data,
          });
          console.log(Role);
    ...
    handleSelectedInRoleStatus(data) {
      alert("handleSelectedInRoleStatus");
      console.log(data);
