                          ...
                          >
                            ...
                            <div class="sm:col-span-6">
                              <label
                                ...
                                class="block text-sm font-medium text-gray-700"
                                >Branch Name in English</label
                              >
                              <div class="mt-1">
                                <input
                                  type="text"
                                  id="branchNameEnglish"
                                  name="branchNameEnglish"
                                  v-model="data.branchNameEnglish"
                                  autocomplete="name"
                            ...
                            <div class="sm:col-span-6">
                              <label
                                for="branchNameArabic"
                                class="block text-sm font-medium text-gray-700"
                                >Branch Name Arabic</label
                              >
                              <div class="mt-1">
                                <input
                                  type="text"
                            ...
                            <div class="sm:col-span-6">
                              <Dropdownlist
                                ...
                                @selected_item="
                                  handleSelectedInMemberMarkAsDelete
                                "
                                name="mark_as_delete"
  ...
  methods: {
    async upsertMember(args) {
      ...
      try {
        ...
        this.data.location.coordinates[0] = parseFloat(
          this.data.location.coordinates[0]
        );
        this.data.location.coordinates[1] = parseFloat(
          this.data.location.coordinates[1]
        );
        if (this.data._id === undefined) {
          const { data: Member } = await useFetch("/api/members/Member", {
            method: "post",
            body: this.data,
          });
        } else {
