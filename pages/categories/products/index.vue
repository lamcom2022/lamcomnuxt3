					...
					<div class="flex-1 flex flex-col overflow-y-auto xl:overflow-hidden">
						...
						<div class="flex-1 flex xl:overflow-hidden">
							...
							<div class="flex-1 xl:overflow-y-auto">
								<ProductPageHeader :heading="pageHeading" showbutton="true"
									guide=""
									addClickEvent="evtUpsertMember" />
								<ProductSearch :heading="searchHeading" />
								<div class="w-full">
									<!-- Main content (start)-->
...
<script>
import ProductPageHeader from "@/pages/categories/products/ProductPageHeader.vue";
import ProductSearch from "@/pages/categories/products/ProductSearch.vue";
import ProductDataTable from "@/pages/categories/products/ProductGrid.vue";



import ProductUpsert from "@/pages/categories/products/ProductUpsert.vue";
